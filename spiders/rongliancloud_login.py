...
class DoubanLoginSpider(scrapy.Spider):
    ...
    name = 'rongliancloud_login'
    # allowed_domains = ['douban.com']
    start_urls = ["https://www.yuntongxun.com/user/login"]
    ...
    def Login(self, response):
        ...
        ''''''
        with open(r'/U/Users/ozintel/Downloads/Tsl_python_progect/local_ml/rongliancloud/rongliancloud/data/start_login.html','wb') as f:
        ...
        #      # '''此时无验证码'''
        data = {
            "loginName": "kejia.wu@hrx.ai",
            "loginPwd": "debfe4c02bda45b869baf9f2add87420",
            "remeberMe": "on",
            "preUrl": "toMain"
        ...
        return [FormRequest.from_response(response,
                                          url="https://www.yuntongxun.com/user/doLogin",  # 真实post地址
    ...
    def crawlerdata(self,response):
        with open(r'/Users/ozintel/Downloads/Tsl_python_progect/znfw_project/znfw_crawer/douban_post_login/data/login_end.html','wb') as f:
            f.write(response.body)
